    ...
    <nav class="navbar navbar-expand-lg nav_color navbar-dark nav_outline">
        ...
        <div class="collapse navbar-collapse justify-content-end col-6" style="padding-right: 20px;" id="navbarNav">
            <ul class="navbar-nav text-center gap-3" style="padding-left: 10px;">
                ...
                <li class="nav-item">
                    <a class="nav-link c-white bg_nav_menu rounded" href="getintouch.php">Contact</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row mx-auto py-5 justify-content-center w-100">
            <div class="col-md-5 nav_color div_outline rounded">
                <form action="php/getintouch-process.php" method="post">
                    <h4 class="c-green text-center mt-3">Get In Touch</h4>
                    <?php if(isset($msg)){ ?>
                    <div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                        <strong>Message Sent!</strong> <?php echo $msg; ?>
                    </div>
                    <?php } ?>
                    <!--first and last name-->
                    ...
                    <div class="mt-3 mb-5">
                        <button type="submit" name="submit" class="btn btn-outline-success mx-auto d-block">Submit</button>
                    </div>
                </form>
            </div>
        </div>
