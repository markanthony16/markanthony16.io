    ...
    <div class="container">
        <div class="row mx-auto py-5 justify-content-center w-100">
            <div class="col-lg-5 col-md-8 nav_color div_outline rounded">
                <form action="php/teacher-forgot-changepass.php" method="post">
                    <h4 class="c-green text-center mt-3">New Password</h4>
                    <!--Email Address-->
                    <div class=" mb-3 mt-3">
                        ...
                        <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                            <strong>Mismatch!</strong> <?php echo $error;?>.
                        </div>
                        <?php }?>
                        <div class="mb-3 mt-2">
                        ...
                        <div class="justify-content-center mt-3 mb-2">
                            <button type="submit" class="btn btn-outline-success mx-auto d-block"
