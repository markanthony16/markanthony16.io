...
$mail = new PHPMailer();
  ...
  require('db-connection.php');
   ...
   if(isset($_POST['submit_email'])) {
      ...
      $sql = "SELECT * FROM registered_student WHERE Email_address = '$email'";
      ...
      if($count == 1) {
        try {
          $actual_link = $serverhosted."/php/forgot-process2.php?email=$email&passwordchange=";
          //Server settings
          ...
          $body = 'Hello <br> Thankyou For Choosing Saint Jude College of Bulacan <br> <br> To reset your password please click the link below and enter your new password. <br>'.$actual_link.' <br> <br> Best regards Saint Jude College of Bulacan. <br> Thank you.';
          $mail->Body = $body;
