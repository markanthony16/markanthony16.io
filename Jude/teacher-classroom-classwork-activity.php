            ...
            <div class="col-lg-8">
                <div class="col-md-12 bg-green">
                    <div class="div_background_light rounded div_outline pb-5 mb-5">
                        <h4 class="fw-bold px-3 py-2 rounded-3 c-white" style="text-align:center;">Make Activity</h4>
                        <!--Make Quiz and Make Questions-->
                        <div class="mx-3">
                            <form action="php/classwork-activity.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group flex-nowrap my-2">
                                    ...
                                    <textarea required name="instruction" class="form-control"
                                        placeholder="Write Instruction or Guide"
                                        onkeyup="textAreaAdjust(this)"></textarea>
                                </div>
                                <div class="input-group flex-nowrap my-2">
                                    <span class="input-group-text" id="addon-wrapping">Close Form Date</span>
                                    <input type="date" required name="dates" class="form-control">
                                </div>
                                <div class="input-group flex-nowrap my-2">
                                    <span class="input-group-text" id="addon-wrapping">Close Form Time</span>
                                    <input type="time" required name="times" class="form-control">
                                </div>
                                <div id="inputfield">
                                    <div class="input-group flex-nowrap my-2">
                                ...
                                <div class="input-group flex-nowrap my-2">
                                    <button type="button" onclick="add_more_field()" class="btn btn-primary">Add More File</button>
                                </div>
                                <div class="input-group flex-nowrap my-2">
